...
var handleSidebar = function handleSidebar() {
  ...
  var sidebarClose = document.getElementById('sidebar-toggle-close');
...
document.getElementById("filterbox-close").addEventListener("click", handleFilterbox, false); // Range Slider
